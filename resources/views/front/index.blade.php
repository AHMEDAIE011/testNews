    ...
    <div class="top-news">
        <div class="container">
            <div class="row">
                ...
                @php
                    $latast_three_posts = $posts->take(3);
                    $latast_four_posts = $posts->take(4);
                @endphp


                <div class="col-md-6 tn-left">
                    <div class="row tn-slider">
                        @foreach ($latast_three_posts as $post)
                            <div class="col-md-6">
                                <div class="tn-img">
                ...
                <div class="col-md-6 tn-right">
                    <div class="row">
                        @foreach ($latast_four_posts as $post)
                            <div class="col-md-6">
                                <div class="tn-img">
                                    <img src="{{ $post->images()->first()->path }}" />
                                    <div class="tn-title">
                        ...
                        <div id="popular" class="container tab-pane fade">
                            @foreach ($gretest_posts_comments as $post)
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        <a href="">{{ $post->title }}: comment {{ $post->comments_count }} </a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
